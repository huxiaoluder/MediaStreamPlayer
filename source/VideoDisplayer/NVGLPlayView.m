...
GLint nvgl_uniforms[NUM_UNIFORMS];
...
- (void)setupGL
{
    ...
    glUniform1i(nvgl_uniforms[UNIFORM_Y], 0);
    glUniform1i(nvgl_uniforms[UNIFORM_UV], 1);
    
    glUniformMatrix3fv(nvgl_uniforms[UNIFORM_COLOR_CONVERSION_MATRIX], 1, GL_FALSE, _preferredConversion);
...
- (void)displayPixelBuffer:(CVPixelBufferRef)pixelBuffer
{
    ...
    if (pixelBuffer != NULL) {
        ...
        if ([EAGLContext currentContext] != _context && _context) {
...
- (BOOL)loadShaders
{
    ...
    nvgl_uniforms[UNIFORM_Y] = glGetUniformLocation(self.program, "SamplerY");
    nvgl_uniforms[UNIFORM_UV] = glGetUniformLocation(self.program, "SamplerUV");
    nvgl_uniforms[UNIFORM_COLOR_CONVERSION_MATRIX] = glGetUniformLocation(self.program, "colorConversionMatrix");
